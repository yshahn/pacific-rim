...
module.exports = async function handler(req, res) {
  ...
  if (resDateParsed && !isNaN(resDateParsed.getTime())) {
    ...
    if (resDateParsed.getTime() < todayStart.getTime()) {
      ...
      return res.status(200).send('<!DOCTYPE html><html><body style="font-family:Arial,sans-serif;text-align:center;padding:60px 24px;"><p>This reservation has already passed. If you\'d like to book a new one, please call us at (404) 893-0018 or visit our website.</p></body></html>');
    }
  }
