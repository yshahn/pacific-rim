...
module.exports = async function handler(req, res) {
  ...
  const { orderItems, subtotal, tax, tip, total, customer, orderId, pickupTime } = req.body;
...
<body style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;background:#f9f9f9;">
  ...
  const pickupTime = req.body.pickupTime || 'ASAP';
...
Requested pick up time: ${pickupTime || 'ASAP'}
...
<body style="font-family:'Helvetica Neue',Arial,sans-serif; max-width:600px; margin:0 auto; padding:24px; color:#1a1a1a; background:#f9f9f9;">
  <div style="background:#fff; border-radius:12px; padding:32px; box-shadow:0 2px 8px rgba(0,0,0,0.06);">
    ...
    <div style="background:#fff8e7;border-left:4px solid #c8a96e;padding:14px 16px;border-radius:4px;font-size:14px;color:#555;margin-bottom:20px;">
      🕐 <strong>Requested Pickup Time:</strong> ${pickupTime || 'ASAP'}
    </div>
