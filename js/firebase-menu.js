...
// ── Save main categories config to Firestore
export async function saveCategoriesToFirebase(categories) {
  try {
    ...
    console.error('Firebase categories save error:', e);
    return false;
  }
}

// ── Load main categories config from Firestore
export async function loadCategoriesFromFirebase() {
  try {
    ...
    console.error('Firebase categories load error:', e);
  }
  return null;
}
