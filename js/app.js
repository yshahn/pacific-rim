      ...
      if (isFirstOfSection) {
        ...
        accHeader.innerHTML =
          '<div class="mi-main" style="width:100%;pointer-events:none;">' +
            ...
            '</div>' +
            '<div style="padding:6px 14px;border-radius:20px;background:var(--gold);color:var(--ink);font-size:12px;font-weight:700;letter-spacing:0.05em;flex-shrink:0;">' + (isOpen ? '접기 ▲' : '보기 ▼') + '</div>' +
          '</div>';
