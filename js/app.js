...
function updateAuthUI() {
  ...
  if (user) {
    ...
    if (greetEl) {
      ...
      greetEl.style.color = '#fff';
      greetEl.style.fontSize = '13px';
...
function goTo(id) {
  ...
  updateNav(id);
  window.scrollTo(0, 0);
  // Always try fill — elements are now visible
  if (id === 'payment') setTimeout(fillUserInfo, 50);
}
