...
function confirmToppingCart() {
  ...
  const checks = document.querySelectorAll('#topping-modal-body input[type="checkbox"]');
  checks.forEach((chk, ti) => {
    if (chk.checked) {
      const t = _toppingItem.toppings[ti];
