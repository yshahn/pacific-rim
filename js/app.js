...
const menuData = {
  ...
  spirits: [
    { e:'🥃', n:'Akashi',       d:'Japanese Whiskey', p:12, img:null },
    { e:'🥃', n:'Yame 10',      d:'Japanese Whiskey', p:15, img:null },
    { e:'🥃', n:'Nikka Coffey', d:'Japanese Whiskey', p:20, img:null },
  ],
  beer: [
    { e:'🍺', n:'Sweet Water 420',              d:'Atlanta, GA',  p:8, img:null },
    { e:'🍺', n:'Creature Comfort Tropicalia',  d:'Atlanta, GA',  p:8, img:null },
    { e:'🍺', n:'Bud Light',                    d:'',             p:6, img:null },
    { e:'🍺', n:'Michelob Ultra',               d:'',             p:6, img:null },
    { e:'🍺', n:'Miller Lite',                  d:'',             p:6, img:null },
    { e:'🍺', n:'Yuengling',                    d:'',             p:6, img:null },
    { e:'🍺', n:'Heineken',                     d:'Holland',      p:8, img:null },
    { e:'🍺', n:'Sapporo',                      d:'Japan',        p:8, img:null },
    { e:'🍺', n:'Kirin Ichiban',                d:'Japan',        p:8, img:null },
    { e:'🍺', n:'Stella Artois',                d:'Belgium',      p:8, img:null },
  ],
  sake: [
    // ── HOUSE SAKE
    { e:'🍶', n:'Hot Sake (4oz)',                  d:'House hot sake',                               p:8,  img:null },
    { e:'🍶', n:'Hot Sake (8oz)',                  d:'House hot sake',                               p:13, img:null },
    { e:'🍶', n:'Nigori Unfiltered - Sho Chiku Bai', d:'Sweet with a fruity nose and mild flavor',  p:20, img:null },
    { e:'🍶', n:'Hakutsuru Draft Sake 300ml',      d:'Draft sake',                                   p:20, img:null },
    // ── PREMIUM SAKE
    { e:'🍾', n:'Hakkaisan (300ml)',               d:'Tokubetsu Junmai',                             p:28, img:null },
    { e:'🍾', n:'Hakkaisan (720ml)',               d:'Tokubetsu Junmai',                             p:70, img:null },
    { e:'🍾', n:'Tizake Tenzan (300ml)',           d:'Genshu Junmai',                                p:57, img:null },
    { e:'🍾', n:'Kikusui Shuzo (300ml)',           d:'Junmai Ginjo',                                 p:32, img:null },
    { e:'🍾', n:'Kikusui Shuzo (720ml)',           d:'Junmai Ginjo',                                 p:78, img:null },
    { e:'🍾', n:'Akashi Shuzo, Dassai 39 (300ml)',d:'Junmai Dai Ginjo',                              p:52, img:null },
  ],
  cocktails: [
    // ── SIGNATURE LIBATIONS
    { e:'🍸', n:'Ginger Martini',         d:'Homemade fresh grated ginger, simple syrup, vodka, fresh lime juice',           p:14, img:null },
    { e:'🍹', n:'Forbidden Mai Tai',      d:"Myers rum, pineapple liqueur, fresh juice",                                     p:13, img:null },
    { e:'🫐', n:'Wild Berry Mojito',      d:'Bacardi rum, fresh berries, fresh lime, mint leaves',                           p:13, img:null },
    { e:'🍑', n:'Ginger Peach Bellini',   d:'Homemade ginger infused simple syrup, peach puree, prosecco champagne',         p:13, img:null },
    { e:'🥭', n:'Peach & Mango Sangria',  d:'Peaches, mangoes, orange liqueur, mint, white wine',                           p:13, img:null },
    // ── CLASSIC COCKTAILS
    { e:'🥃', n:'Old Fashioned',          d:'Straight rye whiskey, straight bourbon whiskey, bitters',                      p:16, img:null },
    { e:'🥃', n:'Tokyo Sidecar',          d:'Akashi Japanese whiskey, Cointreau, lemon juice',                              p:16, img:null },
    { e:'🥃', n:'Sazerac',               d:"Bulleit 95 Rye, Peychaud's bitters, Angostura bitters, sugar cube, absinthe",  p:14, img:null },
    { e:'🍸', n:'Manhattan',             d:'Straight rye whiskey, bourbon, vermouth, bitters',                             p:16, img:null },
    { e:'🍊', n:'Negroni',               d:'Bombay Sapphire gin, Campari, sweet vermouth',                                 p:13, img:null },
  ],
  wine: [
    // ── CHARDONNAY
    { e:'🥂', n:'Hahn Chardonnay (Glass)',              d:'Monterey County, California',                    p:12,  img:null },
    { e:'🍾', n:'Hahn Chardonnay (Bottle)',             d:'Monterey County, California',                    p:40,  img:null },
    { e:'🥂', n:'Kendall-Jackson Chardonnay (Glass)',   d:"Vintner's Reserve, California",                  p:13,  img:null },
    { e:'🍾', n:'Kendall-Jackson Chardonnay (Bottle)',  d:"Vintner's Reserve, California",                  p:45,  img:null },
    { e:'🥂', n:'Sonoma-Cutrer Chardonnay (Glass)',     d:'Russian River Ranches, California',              p:15,  img:null },
    { e:'🍾', n:'Sonoma-Cutrer Chardonnay (Bottle)',    d:'Russian River Ranches, California',              p:55,  img:null },
    { e:'🥂', n:'Clos du Bois Chardonnay (Glass)',      d:'California',                                     p:12,  img:null },
    { e:'🍾', n:'Clos du Bois Chardonnay (Bottle)',     d:'California',                                     p:40,  img:null },
    // ── OTHER WHITES
    { e:'🥂', n:'Danzante Pinot Grigio (Glass)',        d:'Italia',                                         p:12,  img:null },
    { e:'🍾', n:'Danzante Pinot Grigio (Bottle)',       d:'Italia',                                         p:40,  img:null },
    { e:'🥂', n:'Pine Ridge (Glass)',                   d:'Chenin Blanc / Viognier, California',            p:13,  img:null },
    { e:'🍾', n:'Pine Ridge (Bottle)',                  d:'Chenin Blanc / Viognier, California',            p:45,  img:null },
    { e:'🥂', n:'Babich Sauvignon Blanc (Glass)',       d:'Marlborough, New Zealand',                       p:13,  img:null },
    { e:'🍾', n:'Babich Sauvignon Blanc (Bottle)',      d:'Marlborough, New Zealand',                       p:45,  img:null },
    { e:'🥂', n:'White Bordeaux (Glass)',               d:'Borie Noaillan, Bordeaux, France',               p:13,  img:null },
    { e:'🍾', n:'White Bordeaux (Bottle)',              d:'Borie Noaillan, Bordeaux, France',               p:45,  img:null },
    // ── CABERNET SAUVIGNON
    { e:'🥂', n:'Beaulieu Vineyard Cab (Glass)',        d:'B.V. Napa Valley, California',                   p:13,  img:null },
    { e:'🍾', n:'Beaulieu Vineyard Cab (Bottle)',       d:'B.V. Napa Valley, California',                   p:45,  img:null },
    { e:'🥂', n:'Napa Cellars Cab (Glass)',             d:'Napa Valley',                                    p:18,  img:null },
    { e:'🍾', n:'Napa Cellars Cab (Bottle)',            d:'Napa Valley',                                    p:64,  img:null },
    { e:'🍾', n:'Caymus Cab (Bottle)',                  d:'Napa Valley, Rutherford, California',            p:190, img:null },
    { e:'🥂', n:'Joel Gott 815 Cab (Glass)',            d:'Napa, California',                               p:15,  img:null },
    { e:'🍾', n:'Joel Gott 815 Cab (Bottle)',           d:'Napa, California',                               p:55,  img:null },
    { e:'🍾', n:'Justin Cab (Bottle)',                  d:'Paso Robles, California',                        p:65,  img:null },
    { e:'🍾', n:'Silver Oak Cab (Bottle)',              d:'Alexander Valley',                               p:165, img:null },
    // ── MERLOT
    { e:'🥂', n:'Hahn Merlot (Glass)',                  d:'Monterey County',                                p:12,  img:null },
    { e:'🍾', n:'Hahn Merlot (Bottle)',                 d:'Monterey County',                                p:40,  img:null },
    // ── PINOT NOIR
    { e:'🥂', n:'Meiomi Pinot Noir (Glass)',            d:'California',                                     p:15,  img:null },
    { e:'🍾', n:'Meiomi Pinot Noir (Bottle)',           d:'California',                                     p:55,  img:null },
    { e:'🍾', n:'Belle Glos Pinot Noir (Bottle)',       d:'"Clark & Telephone", California',                p:90,  img:null },
    // ── OTHER REDS
    { e:'🥂', n:'Tilia Malbec (Glass)',                 d:'Mendoza, Argentina',                             p:12,  img:null },
    { e:'🍾', n:'Tilia Malbec (Bottle)',                d:'Mendoza, Argentina',                             p:40,  img:null },
    // ── SPARKLING
    { e:'🍾', n:'Maschio Prosecco',                     d:'Italy · 187ml',                                  p:12,  img:null },
    { e:'🥂', n:'Cupcake Moscato (Glass)',              d:'Italy',                                          p:12,  img:null },
    { e:'🍾', n:'Cupcake Moscato (Bottle)',             d:'Italy',                                          p:40,  img:null },
    { e:'🍾', n:'Belaire Rosé (Bottle)',                d:'France',                                         p:65,  img:null },
  ],
  nigiri: [
    // ── NIGIRI SUSHI
...
function buildMenu(tab) {
  ...
  items.forEach((item, idx) => {
    ...
    const headers = (tab === 'nigiri')
      ...
      : (tab === 'wine')
      ? {
          'Danzante Pinot Grigio (Glass)': 'Other Whites',
          'Beaulieu Vineyard Cab (Glass)': 'Cabernet Sauvignon',
          'Hahn Merlot (Glass)':           'Merlot',
          'Meiomi Pinot Noir (Glass)':     'Pinot Noir',
          'Tilia Malbec (Glass)':          'Other Reds',
          'Maschio Prosecco':              'Sparkling',
        }
      : (tab === 'cocktails')
      ? { 'Old Fashioned': 'Classic Cocktails' }
      : (tab === 'sake')
      ? { 'Hakkaisan (300ml)': 'Premium Sake' }
      : (tab === 'lunch')
      ? {
    ...
    div.innerHTML =
      ...
      '<div class="mi-info">' +
        ...
        '<div class="mi-price">$' + parseFloat(item.p).toFixed(2) + '</div>' +
      '</div>' +
