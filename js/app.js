...
const menuData = {
  ...
  entrees: [
    ...
    { e:'🍜', n:'Pad Thai',          d:'Rice noodles, egg, tamarind sauce, peanuts',              p:18, img:null,
      options:[{n:'Chicken',p:20},{n:'Shrimp',p:22},{n:'Tofu',p:18},{n:'Vegetable',p:18}] },
    { e:'🍜', n:'Thai Basil Noodle', d:'Wide rice noodle, Thai basil, bell pepper, spicy sauce',  p:18, img:null,
      options:[{n:'Chicken',p:20},{n:'Shrimp',p:22},{n:'Tofu',p:18},{n:'Vegetable',p:18}] },
    ...
    { e:'🍚', n:'Fried Rice',        d:'Wok fried rice, egg, vegetables',                         p:18, img:IMG+'f9/a2fd50a52c41a09a925a6432ae875d/medium',
      options:[{n:'Vegetable',p:16},{n:'Chicken',p:18},{n:'Shrimp',p:20},{n:'Tofu',p:18}] },
    ...
    div.innerHTML =
      '<div class="mi-main">' +
        ...
        (item.options
          ...
          : '<button class="mi-add' + (inCart ? ' added' : '') + '">' + (inCart ? '✓ ' + inCart : '+') + '</button>'
        ) +
      '</div>' +
      optionsHtml;
    ...
    if (item.multiSelect) {
      ...
      div.querySelectorAll('.mi-opt-row').forEach(row => {
        row.querySelector('.mi-opt-btn').addEventListener('click', function() {
          addToCart(row.dataset.name, parseFloat(row.dataset.price), row.dataset.emoji, this);
