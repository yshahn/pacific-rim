  ...
  items.forEach((item, idx) => {
    ...
    if (tab === 'lunch') {
      ...
      if (item.n === 'Sweet and Sour Fish') {
        ...
        accHeader.innerHTML =
          '<div>' +
            '<div style="font-family:Cormorant Garamond,serif;font-size:20px;font-weight:500;color:var(--ink);">🍱 Bento Box Specials</div>' +
          ...
          '</div>' +
          '<div style="width:28px;height:28px;border-radius:50%;background:var(--ink);color:var(--gold);font-size:18px;font-weight:600;display:flex;align-items:center;justify-content:center;flex-shrink:0;">' + (isOpen ? '−' : '+') + '</div>';
