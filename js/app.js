...
function updateProfileUI() {
  ...
  // Fill form fields
  if (document.getElementById('pf-firstname')) {
    ...
    document.getElementById('pf-zip').value       = profile.zip       || '';
  }
  ...
  if (avatarEl && fullName) {
    avatarEl.textContent = fullName.slice(0,1).toUpperCase();
  }
