...
function selectPickupType(type) {
  pickupType = type;
  const instoreBtn   = document.getElementById('pickup-instore-btn');
  const curbsideBtn  = document.getElementById('pickup-curbside-btn');
  const curbsideInfo = document.getElementById('curbside-info');

  if (type === 'instore') {
    if (instoreBtn)  { instoreBtn.style.background  = 'var(--ink)';      instoreBtn.style.color  = 'var(--gold)'; instoreBtn.style.borderColor = 'var(--gold)'; }
    if (curbsideBtn) { curbsideBtn.style.background = 'var(--card-bg)';  curbsideBtn.style.color = 'var(--ink)';  curbsideBtn.style.borderColor = 'var(--border)'; }
    if (curbsideInfo) curbsideInfo.style.display = 'none';
  } else {
    if (curbsideBtn) { curbsideBtn.style.background = 'var(--ink)';      curbsideBtn.style.color = 'var(--gold)'; curbsideBtn.style.borderColor = 'var(--gold)'; }
    if (instoreBtn)  { instoreBtn.style.background  = 'var(--card-bg)';  instoreBtn.style.color  = 'var(--ink)';  instoreBtn.style.borderColor = 'var(--border)'; }
    if (curbsideInfo) curbsideInfo.style.display = 'block';
