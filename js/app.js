      ...
      if (item.n === 'Sweet and Sour Fish') {
        ...
        accHeader.innerHTML =
          '<div class="mi-main" style="width:100%;pointer-events:none;">' +
            ...
            '<div class="mi-info">' +
              '<div class="mi-name">Bento Box Specials <span style="color:var(--gold);">→</span></div>' +
              '<div class="mi-desc">Served with Miso Soup, House Salad, Spring Roll and Steamed Rice</div>' +
            '</div>' +
