...
const menuData = {
  lunch: [
    // ── BENTO SPECIALS
    { e:'🍱', n:'Sweet and Sour Fish', d:'Stir fried crispy tilapia with red bell pepper, yellow onion, and grape tomatoes with sweet & sour sauce · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Sweet and Sour Fish',p:18}] },
    { e:'🥩', n:'Black Pepper Beef', d:'Stir fried beef with black, red and green bell pepper, onion and touch of home made brown sauce · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Black Pepper Beef',p:18}] },
    { e:'🌿', n:'Fresh Ginger Chicken', d:'Stir fried chicken, red onion, carrot, mushroom over ginger sauce · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:17, img:null,
      options:[{n:'Fresh Ginger Chicken',p:17}] },
    { e:'🧄', n:'Garlic Shrimp', d:'Fresh garlic, garlic brown sauce and steamed broccoli · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Garlic Shrimp',p:18}] },
    { e:'🥩', n:'Mongolian Beef', d:'Sauteed beef, onion, tomatoes, broccoli, mushroom with oyster sauce · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Mongolian Beef',p:18}] },
    { e:'🍛', n:'Thai Yellow Curry (Bento)', d:'Potato, carrot, cashew nut, cucumber pickle · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Shrimp',p:18},{n:'Chicken',p:17},{n:'Tofu',p:16}] },
    { e:'🥑', n:'Green Avocado Curry (Bento)', d:'Asparagus, bell peppers, basil leaf & avocado · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Shrimp',p:18},{n:'Chicken',p:17},{n:'Tofu',p:16}] },
    { e:'🍛', n:'Panang Curry (Bento)', d:'Red and green bell peppers, asparagus, Thai basil leaves · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Shrimp',p:18},{n:'Chicken',p:17},{n:'Tofu',p:16}] },
    { e:'🌿', n:'Spicy Thai Basil (Bento)', d:'Bell peppers, onions & Thai basil leaves · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Shrimp',p:18},{n:'Chicken',p:17},{n:'Tofu',p:16}] },
    { e:'🥩', n:'Spicy Seven Flavored Beef (Bento)', d:'Strips of tender beef marinated in seven spices, wok tossed with fresh Thai basil leaves topped with crushed roasted peanuts, served over bean sprouts · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Spicy Seven Flavored Beef',p:18}] },
    { e:'🍤', n:'Wanchi Shrimp (Bento)', d:'Crispy large shrimp wok tossed with candied walnuts in a honey lemon aioli · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:18, img:null,
      options:[{n:'Wanchi Shrimp',p:18}] },
    { e:'🍗', n:'Grilled Teriyaki Chicken (Bento)', d:'Pan grilled chicken breasts w/ homemade teriyaki sauce served w/ vegetables medley · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:17, img:null,
      options:[{n:'Grilled Teriyaki Chicken',p:17}] },
    { e:'🍗', n:'Grilled Bangkok Chicken (Bento)', d:'Pan grilled chicken breasts marinated w/ lemongrass ginger & honey, w/ homemade sweet chili sauce, served w/ vegetables medley · w/ Miso Soup, House Salad, Spring Roll & Steamed Rice', p:17, img:null,
      options:[{n:'Grilled Bangkok Chicken',p:17}] },
    ...
    { e:'🍣', n:'Sushi Roll Combination - Pick 2', d:'Choose any 2 rolls · w/ Miso Soup or Ginger Salad', p:16.50, img:null,
      multiSelect:[
        { label:'House Rolls / Appetizers', required:true, max:2, choices:['California Roll','Spicy Crab Roll','Spicy Tuna Roll','Philadelphia Roll','Eel Roll','Shrimp Tempura Roll','Alaska Roll','TNT Roll','Crunch Shrimp Roll','Vegetable Roll','Salmon Avocado Roll','Tuna Avocado Roll','Negi Hamachi Roll (6pcs)','Tuna Roll (6pcs)','Salmon Roll (6pcs)','Avocado Roll (6pcs)','Cucumber Roll (6pcs)'] },
        { label:'Soup or Salad', required:true, max:1, choices:['Miso Soup','Ginger Salad','No Soup or Salad'] }
      ]
    },
    { e:'🍣', n:'Sushi Roll Combination - Pick 3', d:'Choose any 3 rolls · w/ Miso Soup or Ginger Salad', p:20, img:null,
      multiSelect:[
        { label:'House Rolls / Appetizers', required:true, max:3, choices:['California Roll','Spicy Crab Roll','Spicy Tuna Roll','Philadelphia Roll','Eel Roll','Shrimp Tempura Roll','Alaska Roll','TNT Roll','Crunch Shrimp Roll','Vegetable Roll','Salmon Avocado Roll','Tuna Avocado Roll','Negi Hamachi Roll (6pcs)','Tuna Roll (6pcs)','Salmon Roll (6pcs)','Avocado Roll (6pcs)','Cucumber Roll (6pcs)'] },
        { label:'Soup or Salad', required:true, max:1, choices:['Miso Soup','Ginger Salad','No Soup or Salad'] }
      ]
    },
    // ── LUNCH APPETIZERS
...
function buildMenu(tab) {
  ...
  // Accordion sections for Lunch tab
  const LUNCH_ACCORDION = [
    'Sweet and Sour Fish',           // first Bento item
    'Special Roll Combination',      // Special Roll Combo
    'Sushi Roll Combination - Pick 2',
    'Sushi Roll Combination - Pick 3',
  ];
  ...
  items.forEach((item, idx) => {
    ...
    if (tab === 'lunch') {
      ...
      const ACCORDION_SECTIONS = {
        'Sweet and Sour Fish':             { label:'Bento Box Specials', key:'bento', items: BENTO_ITEMS },
        'Special Roll Combination':        { label:'Special Roll Combination', key:'special_roll', items:['Special Roll Combination'] },
        'Sushi Roll Combination - Pick 2': { label:'Sushi Roll Combination', key:'sushi_combo', items:['Sushi Roll Combination - Pick 2','Sushi Roll Combination - Pick 3'] },
      };

      // Render accordion header for first item in group
      if (ACCORDION_SECTIONS[item.n]) {
        const sec = ACCORDION_SECTIONS[item.n];
        ...
        accHeader.innerHTML =
          '<div>' +
            '<div style="font-family:Cormorant Garamond,serif;font-size:18px;font-weight:500;">' + sec.label + '</div>' +
            (sec.key==='bento' ? '<div style="font-size:11px;color:var(--muted);margin-top:2px;">Served with Miso Soup, House Salad, Spring Roll and Steamed Rice</div>' : '') +
            (sec.key==='sushi_combo' ? '<div style="font-size:11px;color:var(--muted);margin-top:2px;">Pick 2 ($16.50) · Pick 3 ($20.00)</div>' : '') +
            (sec.key==='special_roll' ? '<div style="font-size:11px;color:var(--muted);margin-top:2px;">w/ Miso Soup or Ginger Salad ($19.50)</div>' : '') +
          '</div>' +
          '<div style="font-size:20px;color:var(--gold);transition:transform 0.2s;" class="acc-arrow-' + sec.key + '">' + (isOpen ? '−' : '+') + '</div>';
        ...
        // Skip item if accordion is closed
        const isInAccordion = BENTO_ITEMS.includes(item.n) ||
          item.n === 'Special Roll Combination' ||
          item.n === 'Sushi Roll Combination - Pick 2' ||
          item.n === 'Sushi Roll Combination - Pick 3';
        if (isInAccordion && !isOpen) {
          return; // skip rendering this item
        }
      } else {
        // Skip accordion items if their section is closed
        const BENTO_ITEMS_CHECK = ['Sweet and Sour Fish','Black Pepper Beef','Fresh Ginger Chicken','Garlic Shrimp','Mongolian Beef','Thai Yellow Curry (Bento)','Green Avocado Curry (Bento)','Panang Curry (Bento)','Spicy Thai Basil (Bento)','Spicy Seven Flavored Beef (Bento)','Wanchi Shrimp (Bento)','Grilled Teriyaki Chicken (Bento)','Grilled Bangkok Chicken (Bento)'];
        if (BENTO_ITEMS_CHECK.includes(item.n) && !window._lunchAccordion['bento']) return;
        if (item.n === 'Special Roll Combination' && !window._lunchAccordion['special_roll']) return;
        if ((item.n === 'Sushi Roll Combination - Pick 2' || item.n === 'Sushi Roll Combination - Pick 3') && !window._lunchAccordion['sushi_combo']) return;
      }
    }
...
function saveProfile() {
  ...
  import(fbUrl).then(({ saveProfileToFirebase }) => {
      ...
      loadProfileFromFirebase(_initUser.email).then(fbProfile => {
        if (fbProfile) {
          const merged = {
            ...
            zip:       fbProfile.zip       || '',
            points:    Math.max(_initUser.points || 0, fbProfile.points || 0),
            pointsLog: _initUser.pointsLog || fbProfile.pointsLog || [],
          };
